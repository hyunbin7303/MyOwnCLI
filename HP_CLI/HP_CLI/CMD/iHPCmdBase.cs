...
{
    [HelpOption("--help")]
    public abstract class iHPCmdBase
    {
        private UserProfile _userProfile;
        private iHPClient _iHPclient;
        ...
        protected string ProfileFolder
        {
            get
            {
                return $"{Environment.GetFolderPath(Environment.SpecialFolder.UserProfile, Environment.SpecialFolderOption.Create)}\\.Kevin\\";
            }
        }
        ...
        protected iHPClient iHPClient
        {
            get
            {
                if (_iHPclient == null)
                {
                    _iHPclient = new iHPClient(_httpClientFactory.CreateClient(), UserProfile, _logger);
                }
        ...
        protected void OutputMyself(XDocument data)
        {
...
/* my SQL server usage with this specific account. 
 * Internet cookie delete automatically - clear record.
 * Azure Storage Detector.
 * Oculys manager. 
 * 
 */